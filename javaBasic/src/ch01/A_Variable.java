...
public class A_Variable {
	...
	public static void main(String[] args) {
		...
		// 1. 중복된 변수명을 사용할 수 없음
		boolean flag;
		// int flag;  중괄호 밖에서는 중복가능
	
		// 2. 숫자로 시작할 수 없음.
		//int 1age;
		int age1;
		
		// 3. 연산자로 사용되는 특수문자를 포함할 수 없음(띄어쓰기도 안됨)
		//int age+;
		int age$_;
		...
		// - Snake Case : 언더바 _로 표현
		String smartPhone;
		String smart_phone;
		// - Upper ~ : 대문자 표현
		// - Lower ~ : 소문자 표현
		// - UpperCamelCase : 첫 문자를 대문자로 시작 (클래스, 인터페이스)
		// - lowerCamelCase : 첫 문자를 소문자로 시작 (변수, 메서드) 자바컴파일언어
		// - UPPER_SNAKE_CASE : 모든 문자를 대문자로 작성 (상수)
		// - lower_snake_case : 모든 문자를 소문자로 작성 (변수, 메서드) 자버스크립트언어
