...
public class D_Control {
	...
	public static void main(String[] args) {
		...
		age = 10;
		if (age > 19) {
			String result = "성인입니다.";             // 코드블록 내부에서만 사용되는 변수는 중복사용가능
			System.out.println("성인입니다.");         // 실행할 구문이 1개면(세미콜론이 1개) 괄호를 삭제해도 됨
		}
		else {
			String result = "성인입니다.";
...
//		switch (변수-일반표현식) {
//		case 값1:
//			변수-일반표현식이 값1과 같을때부터 시작할 코드 위치
//		case 값2:
//			변수-일반표현식이 값2과 같을때부터 시작할 코드 위치
//			switch 내부에서 break문을 만나면 switch문을 종료
//			break;
//		case 값3:
//			변수-일반표현식이 값3과 같을때부터 시작할 코드 위치
//		default:
//			변수-일반표현식이 case의 값과 일치하는 것이 없거나 
//			바로위에서 break문을 만나지 않으면 실행되는 코드 
//		}
...
//		}
		...
		// while: 반복할 횟수가 정해져있지 않을떄 사용하는 반복문
