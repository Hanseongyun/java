...
public class D_Package2 {

	public static void main(String[] args) {

		//Math 클래스: 수학연산과 관련된 다양한 메서드를 제공해주는 클래스
		...
		System.out.println(random.nextInt() % 45);			// -44~-44까지
		
		// Lotto: 1 ~ 45, 중복없는 6개의 수
...
//		System.out.println(lotto);
		...
		// LocalDateTime 클래스: Java8 버전 이후부터 Date 클래스를 대체하기 위해 만들어진 클래스
