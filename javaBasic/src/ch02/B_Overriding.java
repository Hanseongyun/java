...
class SuperClass1 {
	...
	int superInstanceVarialbe;
	
	SuperClass1 (int superInstanceVarialbe) {						//생성자
		this.superInstanceVarialbe = superInstanceVarialbe;
	}
...
//	}
	...
	void instanceMethod(String string) {					// 오버로드
...
class SubClass2 extends SuperClass1 {
	...
	@Override							
	void InstanceMethod() {
		// super 키워드: 자손 클래스에서 조상클래스의 필드 혹은 메서드에 접근할 떄 사용
...
public class B_Overriding {
	...
	public static void main(String[] args) {
		...
		System.out.println(instance1.superInstanceVarialbe);
		System.out.println(instance2.superInstanceVarialbe);
		System.out.println(instance3.superInstanceVarialbe);
